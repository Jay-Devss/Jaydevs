...
Tabs.Dungeon:AddDropdown("MovementMethod", {
    ...
    Default = "Slow (Tween)",
    Multi = false,
    Callback = function(local jay = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua", true))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/SaveManager.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/InterfaceManager.lua"))()
local ReplicatedStorage = game:GetService("ReplicatedStorage") 
local MarketplaceService = game:GetService("MarketplaceService") 
...
local function DungeonText()
    if skipDoubleDungeon then return "Double Dungeon Appear" else return "Dungeon Ends in 18s" end
end
